<%@ Page EnableEventValidation="false" Title=""
    ...
    MasterPageFile="~/WebPortal/OAIMS_New2.Master"
    CodeBehind="Register2.aspx.vb" Inherits="SPIDC.Register2" %>
      ...
      aria-selected="false">Contact</a>
          ...
          <div class="col">
                        <button form="frmSignUp" name="btnSignUp" id="btnSignUp" type="submit" class="btn btn-primary " style="font-size:20px" >Sign Up</button>
                                ...
                                <div class="tab-pane fade" style="display: none;" id="DownloadableFile" role="tabpanel" aria-labelledby="profile-tab">
                                    <ul>
                                        <br />
                                        <div id="caloocan_DF">
        ...
        <!-- Modal ANN Form -->
        <div id="DIV_ANN" runat="server" class="modal fade">
