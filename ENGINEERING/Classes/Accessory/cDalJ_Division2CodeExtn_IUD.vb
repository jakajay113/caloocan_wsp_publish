...
Public Class cDalJ_Division2CodeExtn_IUD
...
#Region "Variable Field"
    ...
    Private Shared _mSelfSupp As String
    Private Shared _mTriGuyed As String
...
#Region "Property Field"
    ...
    Public Shared Property _pSelfSupp() As String
        Get
            Return _mSelfSupp
        End Get
        Set(value As String)
    ...
    Public Shared Property _pTriGuyed() As String
        Get
            Return _mTriGuyed
        End Get
        Set(value As String)
...
#Region "Routine Data"
    ...
    Public Shared Sub _pSave(ByRef _nSuccessful As Boolean, Optional _nCondition As String = "", Optional ByRef _nErrMsg As String = Nothing)
        Try
            ...
            If _mAdd Then
                _nStrSql = "EXEC [sp_J_Division2CodeExtn_IUD] " & _
                "@Action = 'INSERT' " & _
                ",@AppNo = N'" & _mAppNo & "'" & _
                ",@Code = N'" & _mCode & "'" & _
                ",@PermitCode = N'" & _mPermitCode & "'" & _
                ",@Remarks = N'" & _mRemarks & "'" & _
                ",@SelfSupp = N'" & _mSelfSupp & "'" & _
                ",@TriGuyed = N'" & _mTriGuyed & "'" & _
