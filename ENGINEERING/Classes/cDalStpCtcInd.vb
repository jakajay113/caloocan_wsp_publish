...
#Region "Variables Field"
    ...
    Private Shared _mCurrentUser_Left As String
    Private Shared _mCurrentUser_Top As String
...
#Region "Properties Field"
    ...
    Public Shared Property _pCurrentUser_Left() As String
        Get
            Return _mCurrentUser_Left
        End Get
        Set(value As String)
            _mCurrentUser_Left = value
        End Set
    End Property

    Public Shared Property _pCurrentUser_Top() As String
        Get
            Return _mCurrentUser_Top
        End Get
        Set(value As String)
            _mCurrentUser_Top = value
        End Set
    End Property
    ...
    Public Sub _pSubReqinsert()
        Try
            ...
            _nQuery = _
                ...
                IIf(_mCurrentUser_Left = "", "", ",@CurrentUser_Left= N'" & _mYear_Left & "' ") & _
                IIf(_mCurrentUser_Top = "", "", ",@CurrentUser_Top= N'" & _mYear_Top & "' ") & _
              ") "
        ...
        Try
            ...
            Using _nSqlDr
                ...
                Do While _nSqlDr.Read
                    ...
                    If IsDBNull(_nSqlDr.Item("CurrentUser_Left").ToString) Then
                        _mCurrentUser_Left = ""
                    Else
                        _mCurrentUser_Left = UCase(_nSqlDr.Item("CurrentUser_Left").ToString)
                    End If

                    If IsDBNull(_nSqlDr.Item("CurrentUser_Top").ToString) Then
                        _mCurrentUser_Top = ""
                    Else
                        _mCurrentUser_Top = UCase(_nSqlDr.Item("CurrentUser_Top").ToString)
                    End If
    ...
    Public Shared Sub _pSubInsert()
        Try
            ...
            _nStrSql = " EXEC [sp_StpCtcInd_IUD] @Action = 'INSERT'" & _
                                ...
                                IIf(_mCivilStatus_Left = "", "", ",@CivilStatus_Left= N'" & _mCivilStatus_Left & "' ") & _
                                IIf(_mCivilStatus_Top = "", "", ",@CivilStatus_Top= N'" & _mCivilStatus_Top & "' ") & _
                                IIf(_mCurrentUser_Left = "", "", ",@CurrentUser_Left= N'" & _mCurrentUser_Left & "' ") & _
                                IIf(_mCurrentUser_Top = "", "", ",@CurrentUser_Top= N'" & _mCurrentUser_Top & "' ") & _
                                IIf(_mDateIssued_Left = "", "", ",@DateIssued_Left= N'" & _mDateIssued_Left & "' ") & _
                                IIf(_mDateIssued_Top = "", "", ",@DateIssued_Top= N'" & _mDateIssued_Top & "' ") & _
                                IIf(_mFirstName_Left = "", "", ",@FirstName_Left= N'" & _mFirstName_Left & "' ") & _
                                IIf(_mFirstName_Top = "", "", ",@FirstName_Top= N'" & _mFirstName_Top & "' ") & _
