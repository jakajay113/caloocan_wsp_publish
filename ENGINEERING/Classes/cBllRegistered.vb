...
Imports OBO.cEventLog
Imports OBO.cReturnDataType
...
#Region "Routine"
    ...
    Public Shared Function _pFuncVerifyIfAccountIsRegistered( _
        ...
        Try
            ...
            _nDal._pCxn = _mSqlConOAIMS 'cGlobalConnections._pSqlCxn_OAIMS '_mCxn 
    ...
    Public Shared Function _pFuncInsertNewAccount( _
        ...
        Try
            ...
            _nQuery = _
                ...
                "VALUES " & _
                "(@IDNo,@UserId, @FirstName, @LastName, @BirthDate, @SetupGender,@Gender,@SecurityQ,@SecurityA,@Contact_Cp,@Resident,@UserType,@Office,@UserLevel) "
            ...
            Using _nCommand As New SqlCommand
                ...
                _nCommand.Parameters.AddWithValue("@Office", "TAXPAYER")
     ...
     , Optional ByVal xLiteral As String = ""
        ...
        Try
            ...
            _nQuery = _
                ...
                " UserType = 'LGU'," & _
                " Resident = @Resident where UserID = @UserID"
