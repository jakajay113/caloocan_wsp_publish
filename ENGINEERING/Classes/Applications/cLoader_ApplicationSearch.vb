Public Class cloader_ApplicationSearch
...
#Region "Variable Field"
    ...
    Private Shared _mLOIDCode As String
    ...
    Private Shared _mBOIDCode As String
    ...
    Private Shared _mBrowse As Boolean
    Private Shared _mBrowseAIF As Boolean

    Private Shared _mReqLoad As Boolean

#End Region
#Region "Property Field"

    Public Shared Property _pReqLoad() As String
        Get
            Return _mReqLoad
        End Get
        Set(value As String)
    ...
    Public Shared Property _pBrowse() As String
        Get
            Return _mBrowse
        End Get
        Set(value As String)
    ...
    Public Shared Property _pBrowseAIF() As String
        Get
            Return _mBrowseAIF
        End Get
        Set(value As String)
    ...
    Public Shared Property _pBOIDCode() As String
        Get
            Return _mBOIDCode
        End Get
        Set(value As String)
    ...
    Public Shared Property _pLOIDCode() As String
        Get
            Return _mLOIDCode
        End Get
        Set(value As String)
