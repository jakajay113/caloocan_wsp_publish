...
#Region "Variables Data"
    ...
    Public Shared _mEIMSDatabaseName As String
...
#Region "Properties Field"
    ...
    Public Property _pEIMSDatabaseName As String

        Get

            Return _mEIMSDatabaseName

        End Get

        Set(ByVal value As String)

            _mEIMSDatabaseName = value
...
#Region "NYONYIE"
        ...
        Try
            ...
            If _mTransactionType = "CTC Individual" Then
                ...
                _nQuery = "select Or_number,SRS,YEAR(getdate())Year,'Caloocan City' LGUProfile,CONVERT(varchar, getdate(), 101) DateIssued,LastName,FirstName,MiddleName,Gender,TIN,  " & _
                          "Address,Citizenship, BirthPlace,CivilStatus,BirthDate,Occupation,BasicAmount,BusIncome,ProfIncome,	RPTIncome,BusIncome /1000 BusIncomeComputation,ProfIncome / 1000  ProfIncomeComputation,RPTIncome / 1000 RPTIncomeComputation,TaxAmount,Penalty,TotAmount,DelFee from " & _mDatabaseName & "..CTC_Online " & _
                          "INNER JOIN [" & _mEmail & "tmp_table_or] on CTC_Online.Refno =[" & _mEmail & "tmp_table_or].TransactionNumber " & _
                          "where CTC_Type='IND' and PostedDate=FORMAT (getdate(), 'yyyy/MM/dd ')  " & _nwhereSingleOR
                '----------------------------------     
            ElseIf _mTransactionType = "CTC Corporation" Then
    ...
    Public Sub _pSubCreateLoadRecords()
        Try
            ...
            _nQuery = " [SP_CreateLoadTransaction] '" & _mTIMSDatabaseName & "','" & _mBPDatabaseName & "','" & _mRPTDatabaseName & "','" & _mOAIMSDatabaseName & "','" & _mEIMSDatabaseName & "','" & _mEmail & "'"
    ...
    Public Sub _pSubCreateSelectedRecord()
        Try
            ...
            _nQuery = " [SP_CreateTempOR] '" & _mTIMSDatabaseName & "','" & _mBPDatabaseName & "','" & _mRPTDatabaseName & "','" & _mOAIMSDatabaseName & "','" & _mEIMSDatabaseName & "','" & _mServerName & "','" & _mDatabaseName & "','" & _mTransactionType & "','" & _mEmail & "' "
            Dim _nSqlCommand As New SqlCommand(_nQuery, _mSqlConnection)
            _nSqlCommand.ExecuteNonQuery()
            '----------------------------------
        Catch ex As Exception
    ...
    Public Sub _pSubPostOR()
        Try
            ...
            If _mTransactionType = "CTC Individual" Or _mTransactionType = "IND" Then
                ...
                _nQuery = " [SP_PostOR] '" & _mTIMSDatabaseName & "','" & _mBPDatabaseName & "','" & _mRPTDatabaseName & "','" & _mOAIMSDatabaseName & "','" & _mEIMSDatabaseName & "','" & _mServerName & "','" & _mDatabaseName & "','" & _mTransactionType & "','" & _mEmail & "' "
            ...
            ElseIf _mTransactionType = "Business Payment" Then
                _nQuery = " [SP_PostOR] '" & _mTIMSDatabaseName & "','" & _mBPDatabaseName & "','" & _mRPTDatabaseName & "','" & _mOAIMSDatabaseName & "','" & _mEIMSDatabaseName & "','" & _mServerName & "','" & _mDatabaseName & "','" & _mTransactionType & "','" & _mEmail & "' "
            ElseIf _mTransactionType = "EIMS Permit" Then
                _nQuery = " [SP_PostOR] '" & _mTIMSDatabaseName & "','" & _mBPDatabaseName & "','" & _mRPTDatabaseName & "','" & _mOAIMSDatabaseName & "','" & _mEIMSDatabaseName & "','" & _mServerName & "','" & _mDatabaseName & "','" & _mTransactionType & "','" & _mEmail & "' "
            End If
