...
#Region "Variables"
    ...
    Private Shared _mGenID As String

#End Region

#Region "Property Field"

    Public Shared Property _pGenID() As String
        Get
            Return _mGenID
        End Get
        Set(value As String)
...
#Region "Routines"
    ...
    Public Shared Function _FnAutoGenID(ByVal _nModuleID As String, Optional _nReferenceCode As String = Nothing, Optional _nSelectCond As String = Nothing) As String
