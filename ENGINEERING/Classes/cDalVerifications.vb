...
#Region "Routine"
    ...
    Public Sub _pUpdateVerificationAssessor(ByVal approve As Boolean, ByVal Approver As String)
        ...
        Select Case swtch
            ...
            Case "Business"
                    ...
                    Select Case _nMachineName
                        Case "GRACEVILLE"
                           ...
                           "You can now use our Web Service Portal for the following transactions:<br>" & _
                               ...
                               "<br>" & _
                               "Remarks : " & remarks & _
                               "<br><br>You may RENEW your business permit starting January 4, 2021. Please bring the original uploaded files for checking validation." & _
                               "<br><br>Thank you for using our Web Service Portal"
                        Case Else
                            Body = "To our Valued Taxpayer, <br><br>" & _
                ...
                ElseIf resultVerification = "Disapproved" Then
                    Subject = "Business Account Verification"
                    Body = "To our Valued Taxpayer, <br><br>" & _
                           "We sincerely apologized that your enrollment application for Business Account No.: " & no & " was not authorized/disaproved due to the following reasons:<br>" & _
                               "- " & remarks & "<br><br>" & _
            ...
            Case "Property"
                ...
                If resultVerification = "Approved" Then
                    ...
                    Body = "To our Valued Taxpayer, <br><br>" & _
                           "We are happy to inform you that your online enrollment application for TDN: " & no & " has been verified and approved. You can now use our Web Service Portal for the following transactions:<br>" & _
                               ...
                               "- Declaration of New Property <br>" & _
                               "- Cedula <br>" & _
                               "- Miscellaneous <br>" & _
                               "- Appointment <br>" & _
                               "<br>" & _
                ...
                ElseIf resultVerification = "Disapproved" Then
                    Subject = "Real Property Account Verification"
                    Body = "To our Valued Taxpayer, <br><br>" & _
                          "We sincerely apologized that your enrollment application for TDN: " & no & " was not authorized/disaproved due to the following reasons:<br>" & _
                              "- " & remarks & "<br><br>" & _
                              "Please comply the needed requirements in order to proceed with the enrollment procedure.<br>" & _
                           "<br>" & _
                           " Thank you for using our Web Service Portal <br>"
