<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LINKBIZPORTAL.aspx.vb" Inherits="OBO.LINKBIZPORTAL" %>
    ...
    <div class="container">
        <div class="main">            
            <div id="form_id" >  
                ...
                <form id="frm_5.2" method="post" target='_blank' action='http://222.127.109.129:8080/LBP-LinkBiz-RS/rs/postpayment' >            
                    <table>
                        <tr>
                            <td>trxnamt</td>
     ...
     //  document.getElementById('callbackurl').style.width = ((strURL.length + 1) * 8) + 'px';
      ...
      function get_checksum() {          
          ...
          for (i = 0; i < document.getElementsByTagName('INPUT').length-1; i++) {              
              ...
              if (cID == 'bankcode' || cID == 'callbackurl') {
