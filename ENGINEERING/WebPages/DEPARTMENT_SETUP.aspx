<%@ Page MaintainScrollPositionOnPostback="true" Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPages/EIMS_MASTER.Master" CodeBehind="DEPARTMENT_SETUP.aspx.vb" Inherits="EIMS_WEB.DEPARTMENT_SETUP" %>
    ...
    <div class="col-lg-12 card px-0">   
        ...
        <div class="card-body row"> 
            ...
            <div class=" table-responsive col-lg-12">
                ...
                <asp:GridView ID="_oGvDepartmentSetup" runat="server" CssClass="mx-auto mgrid" AllowSorting="true"
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" HeaderText="">
                            <ItemTemplate>                                                                                                                  
                                    ...
                                    <a href="#" onclick="do_delete('<%# Eval("Code")%>','<%# Eval("Desc1")%>','<%# Eval("Desc2")%>')" data-target="#ModalConfirmation" data-toggle="modal">Delete</a>
                                     <a href="#" onclick="__doPostBack('','');" data-toggle="modal">Next</a>
