<%@ Page Language="vb" AutoEventWireup="false"  CodeBehind="Post_EOR.aspx.vb" Inherits="OBO.Post_EOR" MasterPageFile="~/WebPortal/LGUPermitMaster.Master" %>
            ...
            <div class=" col-lg-12">
                ...
                <div class="card col-lg-12 px-0">
                    <div class="card-body col-lg-12 row table-responsive mt-0 mx-auto px-auto">
                        <h6 class="m-2 font-weight-bold text-primary" ><a id="_oLblFUTittle"> Upload and Send Official Reciept </a></h6>
                        ...
                        <br />
                          <div class="row">
                              <div class="col-lg-4  form-group">
                                ...
                                <div class="col-lg-12 form-group">
                                    <label class="input-txt input-txt-active2"><span><span class="m-2">OR No.</span></span></label>
                                    <input type="text" class="form-control CH-Size-new" name=""  style="font-size:xx-large" id="_oTxtORNo"  placeholder="" runat="server" disabled />
                                </div>
...
<c1-pdf-viewer width="100%" id="pdfViewer"></c1-pdf-viewer>
       ...
       <script type="text/javascript">
           function ConfirmUploadNotify() {
               if (confirm('Confirm updload and notify official reciept?')) {
