<%@ Page Title="" Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/WebPortal/LGUOSMainPage.Master" CodeBehind="LGU_GeneralCollectionReport.aspx.vb" Inherits="OBO.LGU_GeneralCollectionReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card shadow col-lg-11 mt-2">
        <div class=" p-2">
...
<%--                            <%--<asp:Label ID="_oLabelAmountPaid" runat="server"  />--%>
            ...
            <div class="col-lg-12 d-flex justify-content-end align-content-end">
                ...
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <button type="button" class="btn btn-primary btn-sm my-3 " id="_obtnProceed" runat="server" onserverclick="_obtnProceed_ServerClick">Proceed</button>
                        <%--<asp:Button runat="server" OnClick="_obtnProceed_ServerClick" text="sample" OnClientClick="disableSubmit(this);"/>--%>
                    </ContentTemplate>
                </asp:UpdatePanel>

                <script type='text/javascript'>
                    function validateEverything(source) {
                        // Create a boolean to determine if your form is valid
                        var isValid = true;

                        // Add your validation logic here

                        // After performing your validation, determine what you should do
                        if (isValid) {
                            // Your form is valid and there are no errors, continue as normal and disable your Button
                            source.disabled = true;
                            return true;
                        }
                        else {
                            // Otherwise something was wrong, don't disable the Button and return false (to avoid submitting)
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-sm-10 float-right">
                    <p class="text-xs font-weight-bold text-primary text-uppercase mb-1" id="_oLabelTransaction1">
                        Number of Transactions:   &nbsp 
                        <asp:Label ID="_oLblCountSPIDCPAY" runat="server"></asp:Label>
                    </p>
                </div>
                <div class="col-sm-2">
                    <p class="text-xs font-weight-bold text-primary text-uppercase mb-1 float-left" id="_oLabelTotal1">
                        Total: &nbsp 
                        <asp:Label ID="_oLblTotalSPIDCPAY" runat="server"></asp:Label>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-sm-10 float-right">
                    <p class="text-xs font-weight-bold text-primary text-uppercase mb-1" id="_oLabelTransaction2">
                        Number of Transactions: &nbsp 
                        <asp:Label ID="_oLblCountPostedSPIDCPay" runat="server"></asp:Label>
                    </p>
                </div>
                <div class="col-sm-2">
                    <p class="text-xs font-weight-bold text-primary text-uppercase mb-1 float-left" id="_oLabelTotal2">
                        Total: &nbsp 
                        <asp:Label ID="_oLblTotalPostedSPIDCPay" runat="server"></asp:Label>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="UnpaidLandBank" class="collapsed show">
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-sm-10 float-right">
                        <p class="text-xs font-weight-bold text-primary text-uppercase mb-1" id="_oLabelTransaction3">
                            Number of Transactions:   &nbsp 
                            <asp:Label ID="_oLblCountLandBank" runat="server"></asp:Label>
                        </p>
                    </div>
                    <div class="col-sm-2">
                        <p class="text-xs font-weight-bold text-primary text-uppercase mb-1 float-left" id="_oLabelTotal3">
                            Total: &nbsp 
                            <asp:Label ID="_oLblTotalLandBank" runat="server"></asp:Label>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div id="PostedLandBank" class="collapsed show">
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-sm-10 float-right">
                        <p class="text-xs font-weight-bold text-primary text-uppercase mb-1" id="_oLabelTransaction4">
                            Number of Transactions:   &nbsp 
                            <asp:Label ID="_oLblCountPostedLandBank" runat="server"></asp:Label>
                        </p>
                    </div>
                    <div class="col-sm-2">
                        <p class="text-xs font-weight-bold text-primary text-uppercase mb-1 float-left" id="_oLabelTotal4">
                            Total: &nbsp 
                            <asp:Label ID="_oLblTotalPostedLandBank" runat="server"></asp:Label>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div id="UnpaidDBP" class="collapsed show">
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-sm-10 float-right">
                        <p class="text-xs font-weight-bold text-primary text-uppercase mb-1" id="_oLabelTransaction5">
                            Number of Transactions:   &nbsp 
                            <asp:Label ID="_oLblCountUnpaidDBP" runat="server"></asp:Label>
                        </p>
                    </div>
                    <div class="col-sm-2">
                        <p class="text-xs font-weight-bold text-primary text-uppercase mb-1 float-left" id="_oLabelTotal5">
                            Total: &nbsp 
                            <asp:Label ID="_oLblTotalUnpaidDBP" runat="server"></asp:Label>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div id="PostedDBP" class="collapsed show">
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="col-sm-10 float-right">
                        <p class="text-xs font-weight-bold text-primary text-uppercase mb-1" id="_oLabelTransaction6">
                            Number of Transactions:   &nbsp 
                            <asp:Label ID="_oLblCountPostedDBP" runat="server"></asp:Label>
                        </p>
                    </div>
                    <div class="col-sm-2">
                        <p class="text-xs font-weight-bold text-primary text-uppercase mb-1 float-left" id="_oLabelTotal6">
                            Total: &nbsp 
                            <asp:Label ID="_oLblTotalPostedDBP" runat="server"></asp:Label>
                        </p>
                    </div>
                </div>
            </div>
