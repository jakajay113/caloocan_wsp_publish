<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/WebPortal/OSMainPage.Master" CodeBehind="PayNow2.aspx.vb" Inherits="OBO.PayNow2" ClientIDMode="Static" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class=" form-group  col-lg-12" style="background-color:#257CFC;padding-bottom:0.5em;padding-top:0.5em;">
                                ...
                                <select required runat="server" id="cmb_PaymentOptions" class="form-control">
                                </select>
                            </div>
                            ...
                            <div class=" form-group  col-lg-12">
                                <table class="col-lg-12" style="font-size: small">
                                    ...
                                    <tr style="border-top: solid 3px black; border-bottom: solid 3px black">
                                        ...
                                        <td style="text-align: right">₱ &nbsp<label id="lbl_TotalAmount" runat="server">0.00</label>
                                            &nbsp</td>
                                    </tr>
                                </table>
                            </div>
